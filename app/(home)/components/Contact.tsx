      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-32">
        ...
        <div className="flex flex-col max-w-lg">
          ...
          <p className="text-gray-300 text-md mt-4 leading-8">
            I&apos;m currently looking for full-time data science/analytics roles and internships for summer 2025. I&apos;d be happy to further discuss my experiences with you—just shoot me an email or fill out the form below :)
          </p>
