...
export default function HeroSection() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col-reverse -mt-[150px] lg:-mt-[0px] lg:flex-row items-center justify-between">
      ...
      <div className="relative pt-8 sm:pt-0 sm:block hidden">
  ...
  <div className="grid grid-cols-2 gap-[4px] w-72 h-72 rotate-[-30deg]">
    ...
    <div className="blob bg-gradient-to-r from-[#a6e3a1] via-[#94e2d5] to-[#89dceb] rounded-2xl w-32 h-32 ml-4 z-12"></div>
    <div className="blob bg-gradient-to-r from-[#8aadf4] via-[#babbf1] to-[#f4b8e4] rounded-full w-32 h-32 ml-4 z-12"></div>
